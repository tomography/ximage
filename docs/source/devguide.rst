...
`Project repository <https://github.com/hspeed/hspeed>`_ 
by clicking the **Fork** button in the header of the 
`Project repository <https://github.com/hspeed/hspeed>`_: 

.. image:: img/fork-repo.png

This successfully creates a copy of hspeed in your personal 
GitHub space. 
...
and integrate well into the rest of hspeed. For example, when you 
...
then you should consider contributing back to hspeed. For this, 
go to your online GitHub repository of hspeed and click on the *compare*
