...
project = u'X-ray Image Analysis'
copyright = u'2017, ' + Affiliation
...
MOCK_MODULES = ['numpy', 'tomopy', 'dxchange', 'matplotlib', 
                'matplotlib.pylab', 'matplotlib.widgets', 
                'matplotlib.pyplot', 'skimage', 'skimage.segmentation', 
                'skimage.morphology', 'scipy', 'scipy.ndimage', ]
